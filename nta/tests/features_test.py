...
def test_nans(sim_trials):
    choice_contingent_cols = ['direction', 'Reward', 'k1',
                              'RL_seq2', 'seq2', 'RL_seq3', 'seq3']
    # Additional tests: selHigh, flag_block, enlp_trial, timeout_block, Switch,
    # rew_seq, loss_seq, outcome_seq
    ...
    prev_choice_contingent_cols = ['k2',
                                   'RL_seq2', 'seq2', 'RL_seq3', 'seq3',
                                   ]
    # Additional tests: 'Switch', '-1outcome_seq_history','-1seq2', '-1seq3',
    # '-1direction', '-1reward'
...
def test_binaries(sim_trials):
    ...
    binaries_with_nans = ['direction', 'Reward', 'timeout']
    # Additional tests: selHigh, flag_block, enlp_trial, timeout_block, Switch
